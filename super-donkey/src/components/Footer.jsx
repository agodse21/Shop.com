...
function Footer() {
  return (
    <>
      ...
      <Box fontSize="13px" borderBottom="1px solid black"  p={2}>
        ...
        <Box w="35%">
          <Flex fontSize="13px" justifyContent="space-evenly">
            <Box   _hover={{ color: "blue" }} borderRight="1px solid black" pr={1}>
              {" "}
              About Us
            </Box>
            <Box  _hover={{ color: "blue" }} borderRight="1px solid black" pr={1}>
      ...
      {/* <Box w="100%" mixBlendMode="multiply" h={10}><Image w="100%" src="https://seal.digicert.com/seals/cascade/?tag=mcRGO2B9&referer=www.shop.com&format=png&lang=en&seal_number=3&seal_size=m&an=min" alt="ll"/></Box> */}
    </>
  );
}
